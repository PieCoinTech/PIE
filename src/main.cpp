...
unsigned int nStakeMinAge = 60 * 1; // 1  min
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
	...
	if(pindexBest->nHeight+1 >= 1 && pindexBest->nHeight+1 <= 10)
    {
...
#ifdef ENABLE_WALLET
// PieCoin: attempt to generate suitable proof-of-stake
